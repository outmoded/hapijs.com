...
exports.all = {
    ...
    'Flitsmeister': {
        ...
        width: 150,
        quote: 'With it’s robust and clean structure, Hapi provides us a solid foundation for both front and backend. We started with Express, but now not looking back with Hapi. Great plugins of the same quality are available, and we\'re even using their code guidelines for our own projects since they feel natural to us.',
