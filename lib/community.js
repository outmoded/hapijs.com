...
exports.all = {
    ...
    'Feedient': {
        ...
        width: 150,
        quote: 'By using hapi we were able to easily let our code evolve with our company and use existing feature without re-inventing the wheel.',
    ...
    'Hood.ie': {
        ...
        width: 150,
        quote: '@svnlto switched us from Express to hapi and with that one change, our server code became manageable and self-descirbing. It has been a boon to the productivity we’ve had at Hoodie and it we have not encountered any production issues since 2.0.',
