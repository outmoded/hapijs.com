...
exports.all = {
    ...
    'Ontoborn': {
        ...
        logo: 'logo-ontoborn.png',
        width: 150,
        quote: 'hapi powers almost all the SAAS platforms that we\'ve built so far. The scalability is amazing and the development experience is exceptional! Kudos to the team that built it.',
        person: 'Jithendra Kumar Rangaraj, Founder & CEO, Ontoborn Technologies LLC'
    },
    'Open Table': {
