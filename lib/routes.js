...
module.exports = (server) => {
    ...
    routes.push({
        ...
        options: {
            ...
            handler: async function (request, reply) {
                ...
                const latestV17 = Utils.findLatestOfMajor(versions, 17);
                ...
                return reply.view('api', { html: ref, versions: [latest, latestV17, lts], tag: current, editLink, apiModules });
            }
        }
    });
    ...
    routes.push({
        ...
        path: '/community',
        options: {
            handler: (request, reply) => reply.view('community', { community: Community, editLink: `${editLinkPrefix}/lib/community.js` })
        }
    });
    ...
    routes.push({
        ...
        options: {
            ...
            handler: (request, reply) => reply.view('document', { title: 'hapi.js community governance', document: request.pre.governance, editLink: 'https://github.com/hapijs/contrib/edit/master/Governance.md' })
        }
    });
    ...
    routes.push({
        ...
        options: {
            ...
            handler: (request, reply) => reply.view('document', { title: 'hapi.js style guide', document: request.pre.styleGuide, editLink: 'https://github.com/hapijs/contrib/edit/master/Style.md' })
        }
    });
    ...
    routes.push({
        ...
        options: {
            ...
            handler: (request, reply) => reply.view('document', { title: 'hapi.js operating guidelines', document: request.pre.guidelines, editLink: 'https://github.com/hapijs/contrib/edit/master/Guidelines.md' })
        }
    });
