...
module.exports = (server) => {
    ...
    routes.push({
        ...
        config: {
            ...
            handler: async function (request, reply) {
                ...
                const ref =  await request.server.methods.github.reference(current.version);
                return reply.view('api', { html: ref, versions: request.pre.versions, tag: current.version });
            }
        }
    });
    ...
    routes.push({
        ...
        config: {
            ...
            handler: (request, reply) => reply.view('document', {
