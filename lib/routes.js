    ...
    config: {
        handler: function (request, reply) {
            ...
            if (request.params.tutorial) {
                if (Tutorials[request.params.lang][request.params.tutorial]) {
                    tutorial = Tutorials[request.params.lang][request.params.tutorial];
                }
                else {
                ...
                tutorial = Tutorials[request.params.lang].default;
            }
            ...
            request.server.methods.markdown.parse(tutorial.contents, (err, html) => {
                ...
                const context = {
                    ...
                    tutorials: Tutorials[request.params.lang].all,
