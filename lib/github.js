...
internals.tags = function (next) {

    return Utils.download('https://api.github.com/repos/hapijs/hapi/tags', internals.requestOptions, next);
};
...
internals.reference = function (tag, next) {
    ...
    return Utils.download('https://api.github.com/repos/hapijs/hapi/contents/docs/Reference.md?ref=' + tag, options, next);
};
...
exports.register = function (plugin, options, next) {
    ...
    plugin.method('github.tags', internals.tags, {
        cache: {
            expiresIn: 900000
        },
        generateKey: function () {
    ...
    plugin.method('github.reference', internals.reference, {
        cache: {
            expiresIn: 900000
        },
        generateKey: function (tag) {

            return 'reference_' + tag;
        }
    });
