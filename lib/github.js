...
exports.methods.push({
    ...
    method: function (callback) {
        ...
        return Utils.download('https://api.github.com/repos/hapijs/hapi/issues?' + params, internals.requestOptions, callback);
    },
    options: {
        cache: {
            expiresIn: Utils.fifteenMinutes
...
exports.methods.push({
    ...
    method: function (callback) {
        ...
        return Utils.download('https://api.github.com/repos/hapijs/hapi/pulls?' + params, internals.requestOptions, callback);
    },
    options: {
        cache: {
            expiresIn: Utils.fifteenMinutes
...
exports.methods.push({
    ...
    method: function (callback) {
        ...
        return Utils.download('https://api.github.com/repos/hapijs/hapi/contents/docs/Governance.md', options, callback);
    },
    options: {
        cache: {
...
exports.methods.push({
    ...
    method: function (callback) {
        ...
        return Utils.download('https://api.github.com/repos/hapijs/hapi/contents/docs/Style.md', options, callback);
    },
    options: {
        cache: {
            expiresIn: Utils.oneDay
...
exports.methods.push({
    ...
    method: function (ref, callback) {
        ...
        return Utils.download('https://api.github.com/repos/hapijs/hapi/contents/docs/Reference.md?ref=' + ref, options, callback);
    },
    options: {
        cache: {
