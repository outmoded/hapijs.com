exports.categories = {
    ...
    'Templating': {
        ...
        'hapi-marko': {
            url: 'https://github.com/jsumners/hapi-marko',
            description: 'This module adds support for the Marko templating language to Hapi.'
        }
    },
    'Utility': {
        ...
        'hapi-configue': {
            url: 'https://github.com/AdrieanKhisbe/hapi-configue',
