...
exports.categories = {
    ...
    'Hypermedia': {
        'hapi-http-problem-details': {
            url: 'https://github.com/PDMLab/hapi-http-problem-details',
    ...
    'Utility': {
        ...
        'hapi-scaffold': {
            url: 'https://github.com/jeffsouza/hapi-scaffold',
        ...
        'hapi-maxmind-web': {
            url: 'https://github.com/midnightcodr/hapi-maxmind-web',
        ...
        'hapi-oracledb': {
            url: 'https://github.com/midnightcodr/hapi-oracledb',
